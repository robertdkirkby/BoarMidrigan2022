...
output_init=(AggVars_init.K.Mean^(Params.alpha))*(AggVars_init.L.Mean^(1-Params.alpha));
...
AggVarsPath=EvalFnOnTransPath_AggVars_Case1(FnsToEvaluate2,AgentDistPath,PolicyPath,PricePath,ParamPath, Params, T, n_d, n_a, n_z, pi_z, d_grid, a_grid,z_grid,simoptions);
...
outputpath=(AggVarsPath.K.Mean.^(Params.alpha)).*(AggVarsPath.L.Mean.^(1-Params.alpha));
